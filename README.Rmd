...
- `extract_condem()`: to crop and mask a geographic subset of the hydrologically 
conditioned elevation model from Hydrosheds.

- `elev_bands()`: to get the fractions of precipitation and catchment area by elevation bands  
...
The hydrologically conditioned elevation for the station can be obtained with:
...
**`{HEgis}`** also provides a function to get the fractions of precipitation and catchment area by elevation bands.
